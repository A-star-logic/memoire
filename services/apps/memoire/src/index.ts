/* eslint-disable unicorn/no-process-exit -- Needed here for graceful exit */
// libs
import {
  logger,
  posthogClient,
...
process.on('unhandledRejection', (reason: Error) => {
  ...
  // eslint-disable-next-line @typescript-eslint/no-floating-promises -- not an issue here
  handleExit(1);
});
...
/* eslint-enable unicorn/no-process-exit -- Needed here for graceful exit */
