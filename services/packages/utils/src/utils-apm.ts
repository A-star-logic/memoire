/* eslint-disable fp/no-class -- A class is a better way to build this */
/* eslint-disable fp/no-this -- This is a class */
...
/* eslint-enable fp/no-class -- A class is a better way to build this */
/* eslint-enable fp/no-this -- This is a class */
